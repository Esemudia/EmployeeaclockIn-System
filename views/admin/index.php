                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <div style="padding-left: 6px;padding-right: 3px;"><i class="fa fa-tachometer"></i></div>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Office Board</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark my-1">Secetary</h3>
                                                <p class="text-muted mb-1 text-truncate">Current Position</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="text-uppercase">Status: <span class="float-right">Onleave</span></h6>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark my-1"><span data-plugin="counterup">60</span>%</h3>
                                                <p class="text-muted mb-1 text-truncate">Office Performance</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="text-uppercase">Rating <span class="float-right">60%</span></h6>
                                        <div class="progress progress-sm m-0">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark my-1"><span data-plugin="counterup">40</span>%</h3>
                                                <p class="text-muted mb-1 text-truncate">Punctuality Rating</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="text-uppercase">Rating <span class="float-right">40%</span></h6>
                                        <div class="progress progress-sm m-0">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark my-1"><span data-plugin="counterup">49</span>%</h3>
                                                <p class="text-muted mb-1 text-truncate">Regularity</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-3">
                                        <h6 class="text-uppercase">Rating <span class="float-right">49%</span></h6>
                                        <div class="progress progress-sm m-0">
