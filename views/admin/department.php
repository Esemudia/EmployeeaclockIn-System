<?php 
 ...
 if(isset($_POST['save']))
 {
     ...
     $dcode=rand(12,100);
     $args=['DepartmentName'=> $dname,'DepartmentShortName'=>$d_sname,'DepartmentCode'=>$dcode,'CreationDate'=>date("Y-m-d")];
                                    ...
                                    <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                                        ...
                                        <tbody>
                                            ...
                                            $retval=Department::find_all();
                                                ...
                                                <td>".$value['DepartmentShortName']."</td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4">
                                <form method="post" name="save">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Department Short Name</label>
                                        <input type="text" class="form-control" name="d_sname" id="d_sname" placeholder="Enter department short name">
                                    </div>
