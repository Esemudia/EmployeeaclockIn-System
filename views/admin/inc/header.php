<?php
    require("../../private/initiliaze.php");
    if( !isset($_SESSION["uname"]))
    {
        header("Location:login.php");
    }
    else if(isset($_SESSION["access_control"])&&isset($_SESSION["uname"])&& isset($_SESSION["email"])&& isset($_SESSION["array"]) && isset($_SESSION["phone"]) &&isset($_SESSION["country"]) &&isset($_SESSION["empId"]) && isset($_SESSION["Id"])){
        $email= $_SESSION["email"];
        //echo json_encode();
        if($_SESSION["access_control"]==1 || $_SESSION["access_control"]==0){
                    ...
                    <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                        ...
                        <div class="collapse navbar-collapse" id="topnav-menu-content">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="leaves.php" id="topnav-apps" role="button"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-plane"></i> Leave Management<div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu mega-dropdown-menu " aria-labelledby="topnav-apps">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div>
                                                    <a href="leaves.php" class="dropdown-item">Leave History</a>
                                                    <a href="leave-type.php" class="dropdown-item">Leave Type</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle arrow-none" href="javascript.void(0)" id="topnav-ui" role="button"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="fa fa-users"></i> Staffs <div class="arrow-down"></div>
                                    </a>
                                    <div class="dropdown-menu mega-dropdown-menu " aria-labelledby="topnav-ui">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div>
                                                    <a href="staffs.php" class="dropdown-item">Staffs</a>
